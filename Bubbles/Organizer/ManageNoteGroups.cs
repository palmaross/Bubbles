...
namespace Organizer
{
    public partial class ManageNoteGroups : UserControl
    {
        ...
        private void btnAddGroup_Click(object sender, EventArgs e)
        {
            ...
            using (StixDB db = new StixDB("OmNotes"))
            {
                ...
                StixMain.m_Notes.cbGroups.Items.Add(item);
        ...
        {
            int selIndex = StixMain.m_Notes.cbGroups.SelectedIndex;
            StixMain.m_Notes.cbGroups.Items.Clear();

            // PreFill group comboboxes (All Groups and No Group)
            StixMain.m_Notes.cbGroups.Items.Add(new NoteGroupItem(Utils.getString("notes.notegroup.all"), -1));
            StixMain.m_Notes.cbGroups.Items.Add(new NoteGroupItem(Utils.getString("notes.notegroup.nogroup"), 0));
            ...
            StixMain.m_Notes.cbGroups.SelectedIndex = selIndex;
        }
    }
}
